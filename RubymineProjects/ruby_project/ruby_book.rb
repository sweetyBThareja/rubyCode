...
#Concatenation:
#The to_s method is obligatory when concatenating Fixnums using the + method or a space; attempting to concatenate a number without using to_s is an error.
#puts "hello" + "world" + 36 #produce error
#puts "hello" + "world" << 36
#puts "hello" << "world" << 36.to_s
#puts "hello" "world" << 36.to_s
